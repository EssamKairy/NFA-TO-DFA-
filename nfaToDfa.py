...
# deleting spaces and line breacks...
i = 0
while i < len(lines):
    txt = lines[i]
    txt = re.sub("\n", "", txt)
...
#generate New deterministic Automata
...
while i < len(states):
    ...
    i = i + 1
#print("the initial state: ",newInitialState)
